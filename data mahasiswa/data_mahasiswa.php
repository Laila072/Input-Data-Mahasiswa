            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_mahasiswa.php?npm=<?php echo $data['npm']; ?>" class="btn btn-sm btn-warning">UPDATE</a>
                            <a href="delete.php?npm=<?php echo $data['npm']; ?>" class="btn btn-sm btn-danger">DELETE</a>
                        </td>
                    </tr>
